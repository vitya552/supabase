...
2. Open the agent that matches the job: [Doctor](/docs/guides/observability/automate-with-agents/health) for health, [Security officer](/docs/guides/observability/automate-with-agents/security) for security, [Personal trainer](/docs/guides/observability/automate-with-agents/performance) for performance, or [Accountant](/docs/guides/observability/automate-with-agents/usage) for usage.
