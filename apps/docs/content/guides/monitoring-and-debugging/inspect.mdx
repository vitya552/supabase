...
A ratio below 99% means Postgres is reading from disk more than from cache. Treat that as a [Performance](/docs/guides/monitoring-and-debugging/debugging) signal, then search [Diagnosing](/docs/guides/troubleshooting).
