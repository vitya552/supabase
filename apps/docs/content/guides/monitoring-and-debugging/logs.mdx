...
If you already have a specific error, start at [Already have a symptom?](/docs/guides/monitoring-and-debugging/debugging#open-the-directory). To pick up a signal from these events, see [Detecting](/docs/guides/monitoring-and-debugging/debugging).
